    ...
    <div className="flex items-center justify-between py-16 xm:px-2">
      <div className="flex items-center justify-center gap-2">
        ...
        <div className="flex flex-col items-start justify-center">
          <div className="text-base font-[500] InterVariable leading-5 tracking-wide text-[#212121] dark:text-[#fbfbfb] md:text-xl md:leading-5">
      ...
      <div className="flex">
        <BlurFade>
          <div className="relative flex gap-2 rounded-full p-1 transition-all hover:cursor-pointer">
            <div
              className={`absolute glow h-1 w-1 rounded-full ${
                activeTab === "Info"
                  ? "left-[80%] top-[90%]"
                  : "left-[30%] top-[90%]"
