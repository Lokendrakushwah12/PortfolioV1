...
const Card = ({ title, description, url }) => {
  return (
    <>
      <div className="relative flex h-[28rem] w-[28rem] flex-col items-start justify-start overflow-hidden bg-[#f2f2f2] shadow-lg xm:h-[24rem] xm:w-[24rem] md:h-[36rem] md:w-[36rem]">
