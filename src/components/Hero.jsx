...
const Hero = () => {
    return (
        <>
            <div className="h-full pb-16 w-full flex justify-start items-start xm:px-2">
                <div className="flex flex-col gap-2">

                    <h1 className='leading-[2.4rem] md:leading-[3.85rem] xm:text-2xl text-3xl md:text-5xl'>
                        <span className='bg-[rgba(16,178,1,0.15)] font-[400] text-[rgb(16,178,1)] rounded-sm'>
                            Frontend developer
                        </span>
                        &nbsp;with a knack <br />
                    ...
                    <div className="flex w-full justify-between items-center">
                        ...
                        <Link to='/resume' className='flex justify-center items-center gap-1 bg-[rgba(16,178,1,0)] hover:border-[rgba(16,178,1,0.15)] border-[#fafaf9] border-b text-[rgb(16,178,1)] hover:text-[rgb(16,178,1)] font-[400] xm:text-sm text-base md:text-xl'>
                            Resume
                            <svg className='w-3 md:w-5' width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M0 1H15M15 0.25V16M15 1L0.833333 15.1667" stroke="#10b201" stroke-opacity="1" stroke-width="1.5" />
                            </svg>
